...
if __name__ == '__main__':
    with log as logger:
        ...
        for log in (True, False):
            ...
            cp.utils.xy_plot(f'ionization_vs_phase__pw={uround(pw, asec, 3)}as_flu={uround(flu, Jcm2, 3)}Jcm2__log={log}',
            ...
            cp.utils.xy_plot(f'ionization_vs_phase__pw={uround(pw, asec, 3)}as_flu={uround(flu, Jcm2, 3)}Jcm2__log={log}__rel',
                             [r.spec.phase / pi for r in results],
