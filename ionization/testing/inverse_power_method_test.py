...
if __name__ == '__main__':
    with cp.utils.Logger('compy', 'ionization', stdout_logs = True, stdout_level = logging.DEBUG) as logger:
        ...
        cp.utils.xy_plot('evolved_g_difference_lin_log',
        ...
        cp.utils.xy_plot('evolved_g_difference_log',
                         sim.mesh.r, *pre_post_differences,
                         line_labels = labels,
                         x_scale = 'bohr_radius', x_label = r'$r$', y_label = r'$\left| g_{\mathrm{pre}} \right|^2  - \left|g_{\mathrm{post}} \right|^2$',
                         y_log_axis = True, x_log_axis = False,
        ...
        cp.utils.xy_plot('evolved_g_difference_log_log',
                         sim.mesh.r, *pre_post_differences,
                         line_labels = labels,
                         x_scale = 'bohr_radius', x_label = r'$r$', y_label = r'$\left| g_{\mathrm{pre}} \right|^2  - \left|g_{\mathrm{post}} \right|^2$',
                         y_log_axis = True, x_log_axis = True,
        ...
        cp.utils.xy_plot('evolved_g_fractional_difference_log',
        ...
        cp.utils.xy_plot('evolved_g_fractional_difference_log_log',
                         sim.mesh.r, *pre_post_fractional_differences,
                         line_labels = labels,
                         x_scale = 'bohr_radius', x_label = r'$r$', y_label = r'$\frac{ \left| g_{\mathrm{pre}} \right|^2  - \left|g_{\mathrm{post}} \right|^2 }{\left| g_{\mathrm{pre}} \right|^2}$',
                         y_log_axis = True, x_log_axis = True,
