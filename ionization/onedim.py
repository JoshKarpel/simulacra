...
class OneDimensionalSimulation(cp.Simulation):
    ...
    #
    # def angular_fft(a, x):
    #     return fft.fft(a, norm = 'ortho'), (2 * np.pi) * fft.fftfreq(len(x), x[1] - x[0])
    #
    #
    # def angular_ifft(a):
    #     return fft.ifft(a, norm = 'ortho')
    #
    #
    # class SpectralMethod1DParameters(Parameters):
    #     def __init__(self, name, file_name = None,
    #                  x_lim = 20 * bohr_radius, x_points = 2 ** 13,
