...
if __name__ == '__main__':
    with cp.utils.Logger('compy', 'ionization', stdout_logs = True, stdout_level = logging.INFO) as logger:
        ...
        for flu in [.1, .5, 1, 5, 10, 20]:
            physics_str = 'sinc__omega_c=twopi{}THz_lambda={}_flu={}__pw={}asto{}as__{}pws__phases={}'.format(
                omega_c,
                l,
                round(flu, 3),
            ...
            for pw in pulse_widths:
                for phase in phases:
                    ...
                    electric_field = ion.SincPulse.from_omega_carrier(pulse_width = pw * asec, fluence = flu * Jcm2, phase = phase, omega_carrier = twopi * omega_c * THz,
                                                                      window = ion.SymmetricExponentialTimeWindow(window_time = (t_bound_per_pw - 1) * pw * asec, window_width = .5 * pw * asec))
