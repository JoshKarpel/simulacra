...
UNIT_NAME_TO_LATEX.update(
    {
        ...
        "um": r"\mathrm{\mu m}",
        "micrometer": r"\mathrm{\mu m}",
        "micrometers": r"\mathrm{\mu m}",
        "micron": r"\mathrm{\mu m}",
        "microns": r"\mathrm{\mu m}",
        "nm": r"\mathrm{nm}",
...
pg = 1e-12 * g
fg = 1e-15 * g
proton_mass = 1.672_621_898e-27 * kg
neutron_mass = 1.674_927_471e-27 * kg
...
UNIT_NAME_TO_LATEX.update(
    {
        ...
        "per_us": r"\mathrm{\mu s^{-1}}",
        "per_usec": r"\mathrm{\mu s^{-1}}",
...
atomic_intensity = 0.5 * epsilon_0 * c * (atomic_electric_field ** 2)
...
atomic_magnetic_dipole_moment = bohr_magneton = (
    proton_charge * hbar / (2 * electron_mass)
)
