...
if __name__ == '__main__':
    with cp.utils.Logger(stdout_level = logging.DEBUG, file_logs = True, file_dir = OUT_DIR, file_level = logging.DEBUG) as logger:
        ...
        spec = disp.ContinuousAmplitudeSpectrumSpecification.from_power_spectrum_csv('TiSapph_{}THz_{}pts'.format(uround(f_max - f_min, THz, 0), power), frequencies, optics, 'tisapph_spectrum.txt', total_power = 150 * mW)
        ...
        sim.plot_autocorrelation(save = True, target_dir = OUT_DIR, name_postfix = 'before')
